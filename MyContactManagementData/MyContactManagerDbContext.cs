...
namespace MyContactManagementData
{
    public class MyContactManagerDbContext : DbContext
    {
        // Allows you to use a builder to get the connection string
        ...
        // OnConfiguring: Bring in connection string using the configuration builder. This config will enable scaffolding and database updates.
